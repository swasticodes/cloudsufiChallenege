...
public class GeburtstagPage 
{
	...
	//By link_Birthday_First_Item = By.xpath("//*[contains(@class, \"widget-teaser-tile highlight-banner\")]/ancestor::div[1]/following-sibling::div/div[2]/div/div/div/div/div");
	...
	public WebElement linkBirthdayFirstItem()
	{
		...
		//return driver.findElement(link_Birthday_First_Item);
	}
