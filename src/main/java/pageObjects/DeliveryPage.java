...
public class DeliveryPage 
{
	...
	@FindBy (xpath="//*[contains(text(), 'Weiter zur Grußkarte')]") WebElement btn_Continue_To_GreeatingCard;
	@FindBy (xpath="//*[contains(text(), 'Weiter ohne Grußkarte')]") WebElement btn_Continue_Without_GreetingCard;
